...
func NewBtcWallet(symbol string, privateKey string, chainId int, segWitType SegWitType, chainParams *chaincfg.Params) (*BtcWallet, error) {
...
func NewBtcWalletByPath(symbol string, path string, seed []byte, segWitType SegWitType, chainParams *chaincfg.Params) (*BtcWallet, error) {
